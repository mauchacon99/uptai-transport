                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table browser no-border">
                                    <tbody>
                                        <tr>
                                            <td><img src="{{ du_asset( 'layout-5/img/browser/chrome-logo.png' ) }}" alt="logo"></td>
                                            <td>Google Chrome</td>
                                            <td class="text-right"><span class="label label-primary">33%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ du_asset( 'layout-5/img/browser/firefox-logo.png' ) }}" alt="logo"></td>
                                            <td>Mozila Firefox</td>
                                            <td class="text-right"><span class="label label-success">27%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ du_asset( 'layout-5/img/browser/safari-logo.png' ) }}" alt="logo"></td>
                                            <td>Apple Safari</td>
                                            <td class="text-right"><span class="label label-info">17%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ du_asset( 'layout-5/img/browser/internet-logo.png' ) }}" alt="logo"></td>
                                            <td>Internet Explorer</td>
                                            <td class="text-right"><span class="label label-warning">11%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ du_asset( 'layout-5/img/browser/opera-logo.png' ) }}" alt="logo"></td>
                                            <td>Opera mini</td>
...
@section('head-assets')
		...
		<link href="{{ du_asset( 'layout-5/lib/chartjs/chartjs-sass-default.css' ) }}" rel="stylesheet">
...
@section('footer-assets')
        ...
        <script src="{{ du_asset( 'layout-5/js/dashboard.js' ) }}"></script>
