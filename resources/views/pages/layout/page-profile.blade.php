                ...
                <div class="col-md-4">
                    <div class="widget white-bg">
                        <div class="padding-20 text-center">
						 <img alt="Profile Picture" width="140" class="rounded-circle mar-btm margin-b-10 circle-border " src="{{ du_asset( 'layout-5/img/avtar-2.png' ) }}">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="timeline">
                                <div class="widget white-bg">
                                    <ul class="comments-list list-unstyled clearfix">
                                        <li class="clearfix">
                                            <img src="{{ du_asset( 'layout-5/img/avtar-2.png' ) }}" alt="" width="70" class="rounded-circle circle-border">
                                            <div class="content">
                                        ...
                                        <li class="clearfix">
                                            <img src="{{ du_asset( 'layout-5/img/avtar-3.png' ) }}" alt="" width="70" class="rounded-circle circle-border">
                                            <div class="content">
                                                <div class="comments-header">
                                                    <strong>John Doe</strong>
                                                    <small class="text-muted">30 Minutes Ago</small>
                                        ...
                                        <li class="clearfix">
                                            <img src="{{ du_asset( 'layout-5/img/avtar-4.png' ) }}" alt="" width="70" class="rounded-circle circle-border">
                                            <div class="content">
                                                <div class="comments-header">
                                                    <strong>John Doe</strong>
                                                    <small class="text-muted">30 Minutes Ago</small>
