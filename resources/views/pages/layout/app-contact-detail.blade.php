                ...
                <div class="col-md-4">
                    <div class="widget white-bg">
                        <div class="padding-20 text-center">
						 <img alt="Profile Picture" width="140" class="rounded-circle mar-btm margin-b-10 box-shadow " src="{{ du_asset( 'layout-5/img/avtar-2.png' ) }}">
                        ...
                        <div class="card-body">
                           ...
                           <form method="post" class="well well-default">
							...
							<div class=" float-right">
								<a href="#" class="btn btn-primary btn-rounded box-shadow">Send</a>
							</div>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="timeline">
                                <div class="widget white-bg">
                                    <ul class="comments-list list-unstyled clearfix">
                                        <li class="clearfix">
                                            <img src="{{ du_asset( 'layout-5/img/avtar-2.png' ) }}" alt="" width="70" class="rounded-circle">
                                            <div class="content">
												...
												<ul class="list-inline row">
                                                    <li><a href="#">
                                                            <img alt="" src="{{ du_asset( 'layout-5/img/gallery/1s.jpg' ) }}" class="img-fluid rounded" width="100">
                                                        </a></li>
                                                    <li><a href="#">
                                                            <img alt="" src="{{ du_asset( 'layout-5/img/gallery/2s.jpg' ) }}" class="img-fluid rounded" width="100">
                                                        </a></li>
                                                    <li><a href="#">
                                                            <img alt="" src="{{ du_asset( 'layout-5/img/gallery/3s.jpg' ) }}" class="img-fluid rounded" width="100">
                                                        </a></li>
                                                </ul>
												<ul class="list-inline row">
                                        ...
                                        <li class="clearfix">
                                            <img src="{{ du_asset( 'layout-5/img/avtar-3.png' ) }}" alt="" width="70" class="rounded-circle">
                                            <div class="content">
                                                <div class="comments-header">
                                                    <strong>John Doe</strong>
                                                    <small class="text-muted">30 Minutes Ago</small>
                                        ...
                                        <li class="clearfix">
                                            <img src="{{ du_asset( 'layout-5/img/avtar-4.png' ) }}" alt="" width="70" class="rounded-circle">
                                            <div class="content">
                                                <div class="comments-header">
                                                    <strong>John Doe</strong>
                                                    <small class="text-muted">30 Minutes Ago</small>
