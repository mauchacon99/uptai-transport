                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="profiletimeline">
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="{{ asset( 'admin/img/avtar-1.png' ) }}" alt="user" class="rounded-circle"> </div>
                                        <div class="sl-right">
                                            <div><a href="#" class="link">John Doe</a> <span class="sl-date">12 minutes ago</span>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-6 mb-2"><img src="{{ asset( 'admin/img/gallery/1s.jpg' ) }}" alt="user" class="img-fluid rounded"></div>
                                                    <div class="col-lg-3 col-md-6 mb-2"><img src="{{ asset( 'admin/img/gallery/2s.jpg' ) }}" alt="user" class="img-fluid rounded"></div>
                                                    <div class="col-lg-3 col-md-6 mb-2"><img src="{{ asset( 'admin/img/gallery/3s.jpg' ) }}" alt="user" class="img-fluid rounded"></div>
                                    ...
                                    <hr>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="{{ asset( 'admin/img/avtar-2.png' ) }}" alt="user" class="rounded-circle"> </div>
                                        <div class="sl-right">
                                            <div> <a href="#" class="link">John Doe</a> <span class="sl-date">8 minutes ago</span>
                                                <div class="mt-2 row">
                                                    <div class="col-md-3 col-xs-12"><img src="{{ asset( 'admin/img/gallery/1s.jpg' ) }}" alt="user" class="img-fluid rounded"></div>
                                    ...
                                    <hr>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="{{ asset( 'admin/img/avtar-3.png' ) }}" alt="user"> </div>
                                        <div class="sl-right">
                                    ...
                                    <hr>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="{{ asset( 'admin/img/avtar-4.png' ) }}" alt="user" class="rounded-circle"> </div>
                                        <div class="sl-right">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table browser no-border">
                                    <tbody>
                                        <tr>
                                            <td><img src="{{ asset( 'admin/img/browser/chrome-logo.png' ) }}" alt="logo"></td>
                                            <td>Google Chrome</td>
                                            <td class="text-right"><span class="label label-primary">33%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ asset( 'admin/img/browser/firefox-logo.png' ) }}" alt="logo"></td>
                                            <td>Mozila Firefox</td>
                                            <td class="text-right"><span class="label label-success">27%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ asset( 'admin/img/browser/safari-logo.png' ) }}" alt="logo"></td>
                                            <td>Apple Safari</td>
                                            <td class="text-right"><span class="label label-info">17%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ asset( 'admin/img/browser/internet-logo.png' ) }}" alt="logo"></td>
                                            <td>Internet Explorer</td>
                                            <td class="text-right"><span class="label label-warning">11%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ asset( 'admin/img/browser/opera-logo.png' ) }}" alt="logo"></td>
                                            <td>Opera mini</td>
...
@section('footer-assets')
        ...
        <script src="{{ asset( 'admin/lib/chartjs/chartjs-sass.js' ) }}"></script>
